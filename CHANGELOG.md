...
- **Bubble Menu Architecture**: Refactored all bubble menus to extend a shared base class, significantly reducing code duplication and improving maintainability.
